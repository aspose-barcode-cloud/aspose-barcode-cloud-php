...
class ScanBarcodeRequest
{
     ...
     * @param string $checksum_validation Checksum validation setting. Default is ON.
     */
    public function __construct($image_file, $decode_types = null, $timeout = null, $checksum_validation = null)
    {
