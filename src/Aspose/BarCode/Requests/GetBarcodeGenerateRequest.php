...
/**
 * --------------------------------------------------------------------------------------------------------------------
 * <copyright company="Aspose" file="GetBarcodeGenerateRequest.php">
...
/**
 * Request model for "getBarcodeGenerate" operation.
 */
class GetBarcodeGenerateRequest
{
    /**
     * Initializes a new instance of the GetBarcodeGenerateRequest class.
     *
